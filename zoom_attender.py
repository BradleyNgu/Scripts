...
def good_morning_chat():
    introduction_dialogue =  ["Good morning miss", "Hello!", "Good morning", "morning"] #list of introductions strings
    ...
    time.sleep(2)
    pyautogui.write(introduction_dialogue[randint(0,3)] , interval=0.01)  # Type the message
